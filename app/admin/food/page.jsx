...
import { saveFoodItem } from '../../../_actions/postAction';
...
function FormModal({ showModal, setShowModal, onSave }) {
  ...
  const handleSaveFoodItem = async () => {
    ...
    const result = await saveFoodItem(foodItem);
